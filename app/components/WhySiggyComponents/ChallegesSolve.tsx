          ...
          <div className="w-full text-center ">
            ...
            Challenges We  <span className="text-[#8ED3FA] ">   Solve</span>
                ...
                <p className=" text-white max-w-[833px] font-normal text-[16px] md:text-[18px] leading-[28px] mx-auto">
                    Traditional mobile networks are hindered by overloaded towers, environmental obstructions, and
rigid switching logic. Siggy replaces reactive systems with adaptive AI that dynamically adjusts
