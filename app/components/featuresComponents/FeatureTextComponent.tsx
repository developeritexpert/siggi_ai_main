...
const FeatureTextComponent = ({imageParaText,imageSpanText}) => {
  return (
                 ...
                 <div className="flex flex-row gap-2 mb-[20px] items-baseline">
                  ...
                  <p className="text-[#8ED3FA] text-[14px] md:text-[18px ] max-w-[570px] font-semibold leading-[28px]">
                    {imageParaText}
                    <span className="text-[18px] text-white font-normal">{imageSpanText}</span></p>
                 </div>
